...
- Contact clients the afternoon prior to their scheduled appointments to verify trip times, pickup locations, and details.  
- Maintain daily, clear communication with the office Transportation Coordinators and administrative staff.  
- Assist with Agency wheelchair transports.  
- Participate reliably in the weekly on-call rotation and flex scheduled work hours as operationally required.  
- Demonstrate a deep understanding of the Agency’s Mission Statement and actively carry it out in all daily interactions and tasks.  
- Perform alternative tasks and responsibilities as assigned by the supervisor to support the team.  
...
- High level of precision in managing schedules, verifying client data, and tracking vehicle logs.  
