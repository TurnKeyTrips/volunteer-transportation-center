...
- Partner with Transportation Specialists to streamline pick-up and drop-off issues.  
- Enforce total compliance with DOT and OSHA.  
- Ensure all vehicles undergo pre and post trip inspections, logging defects and coordinating with outside Agency mechanics for rapid repairs.  
- Lead accident investigations, document root causes, and submit detailed reports to the Compliance Officer.  
- Provide training for and assist with wheelchair transports.  
- Assist with interviewing, hiring, training, and evaluating drivers.  
- Perform ride-along assessments to evaluate driver safety, professionalism, and adherence to fuel-efficient driving habits.  
- Host regular safety meetings and toolbox talks to build a positive, safety-first culture.  
